...
// Retained only to prove the data-driven VeloxTestSettings is equivalent; see
// VeloxSettingsMigrationSuite. Delete both once the migration lands.
class VeloxTestSettingsLegacy extends BackendTestSettings {
