 ...
 */
package org.apache.gluten.sql.shims.sparkmain
...
import org.apache.spark.sql.catalyst.util.{MapData, TimestampFormatter}
...
class SparkMainShims extends SparkShims {
  ...
  override def getCommonPartitionValues(
    ...
    // SPJ (Storage Partitioned Join) feature was removed in Spark 4.2
    None
  }
  ...
  override def orderPartitions(
    ...
    // Return partitions as-is without reordering
    filteredPartitions
  }
