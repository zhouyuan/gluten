...
import org.apache.gluten.datasource.ArrowJSONOptionConverter
...
case class ArrowJSONTable(
  ...
  override def inferSchema(files: Seq[FileStatus]): Option[StructType] = {
    ...
    val parsedOptions: JSONOptions = new JSONOptions(
    ...
    ArrowUtil.readSchema(
      files.head,
      org.apache.arrow.dataset.file.FileFormat.JSON,
      arrowConfig,
      allocator,
      pool
    )
  ...
  override def newScanBuilder(options: CaseInsensitiveStringMap): ScanBuilder = {
    ArrowJSONScanBuilder(sparkSession, fileIndex, schema, dataSchema, options)
  }
  ...
  override def formatName: String = "arrowjson"
}
